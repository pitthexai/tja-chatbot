...
;
const ChatPage = ()=>{
    // Get the initial query from the URL (e.g., ?initial=...)
    ...
    const [abstracts, setAbstracts] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    // Function to initiate a chat query and simulate a response.
    const initiateChat = (question)=>{
        ...
        // Simulate a bot response and article abstracts retrieval.
        setTimeout(()=>{
            const botMessage = {
                id: Date.now() + 1,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__fc73ff._.js.map